...
#   agy 0.42.0 does not support the --output-format/--model/reasoning flags → it steers the
...
class AntigravityCliAdapter:
    ...
    async def generate_structured(
        ...
        *,
        ...
        # If an API key was provided via environment variable or parameter, prefer calling the Gemini API directly instead of the agy CLI (works around sandbox login errors)

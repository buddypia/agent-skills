...
#   agy 0.42.0 does not support the --output-format/--model/reasoning flags -> it produces
...
class AntigravityCliAdapter:
    ...
    async def generate_structured(
        ...
        *,
        ...
        # If an API key was provided via an environment variable or parameter, prefer calling the Gemini API directly instead of the agy CLI (to work around sandbox login errors)
